  ...
  return (
    <div className="relative z-50 flex items-center justify-center min-h-screen" style={{ overflow: 'hidden' }}>
      ...
      <div className="text-white text-center px-4">
        ...
        <h1 className="text-2xl md:text-4xl font-bold pr-4 md:pr-30 pl-4 md:pl-30 drop-shadow-[0_0_15px_white] border-b-3 rounded-2xl pb-3">Menu</h1>
        </div>
        ...
        <div className="flex flex-col items-center gap-4 border-white border-2 rounded-4xl shadow-[0_0_15px_white] pt-5 pb-5 px-4 md:px-0">
          ...
          <div className="flex pt-5 z-50 gap-2 md:gap-0">
            <a href="https://www.instagram.com/333.kitty/" className="pr-2 md:pr-5 hover:drop-shadow-[0_0_10px_white] transition duration-300"><FaInstagram size={30} className="md:w-10 md:h-10" /></a>
            <a href="https://www.linkedin.com/in/%C3%A1urea-s-carminato-757125254/" className="pr-2 md:pr-5 hover:drop-shadow-[0_0_10px_white] transition duration-300"><FaLinkedin size={30} className="md:w-10 md:h-10" /></a>
            <a href="https://github.com/ByAurea" className="pr-2 md:pr-5 hover:drop-shadow-[0_0_10px_white] transition duration-300"><FaGithub size={30} className="md:w-10 md:h-10" /></a>
            <a href="mailto:aureascarminato@gmail.com" className="pr-2 md:pr-5 hover:drop-shadow-[0_0_10px_white] transition duration-300"><MdEmail size={30} className="md:w-10 md:h-10" /></a>
